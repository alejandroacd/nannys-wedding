...
export default function DressCode() {
    const { t } = useLanguage();
    return <section id="dresscode" className="p-4 md:w-1/2 md:mx-auto py-12">
        <section  className=" mx-auto flex flex-col p-5">
            ...
            <FadeInSection>
                <h1 className={`text-5xl md:text-7xl  ${greatVibes.className} md:text-center my-5 text-primary font-bold`}>{t("menu_dresscode")}</h1>
            </FadeInSection>
